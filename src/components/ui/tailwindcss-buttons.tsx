...
export const ButtonsCard = ({
  ...
  return (
    <div
      onClick={onClick}
      className={cn(
        "h-14 w-30 bg-white rounded-xl border border-neutral-100 dark:bg-black dark:border-white/[0.2] hover:border-neutral-200 group/btn overflow-hidden relative flex items-center justify-center",
        className
      )}
    >
